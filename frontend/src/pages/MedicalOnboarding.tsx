    ...
    <div className="bg-background text-on-background min-h-screen font-body-md overflow-x-hidden">
      ...
      <main className="pt-24 pb-12 px-4 md:px-margin-desktop max-w-5xl mx-auto">
        <div className="mb-12">
          <div className="flex justify-between items-center relative">
            ...
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              <div
                className="w-10 h-10 rounded-full flex items-center justify-center bg-primary text-on-primary shadow-lg transition-colors border-4 border-background"
                id="step-circle-1"
              >
                <span
            ...
            <div className="flex flex-col items-center gap-2 group cursor-pointer">
              <div
                className="w-10 h-10 rounded-full flex items-center justify-center bg-surface-container-high text-on-surface-variant transition-colors border-4 border-background"
                id="step-circle-2"
              >
                <span
                  className="material-symbols-outlined"
        ...
        <div className="bg-surface-container-low rounded-xl p-6 md:p-10 shadow-sm min-h-[600px] flex flex-col">
          <section
            className="active-step step-transition space-y-8"
            id="wizard-step-1"
          >
            <div className="border-b border-outline-variant pb-6">
              ...
              <p className="font-body-md text-on-surface-variant">
                Please provide details regarding your chronic conditions and
                previous surgical procedures to help us tailor your care plan.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <label className="block">
                  <span className="font-label-lg text-label-lg text-on-surface mb-2 block">
                    Chronic Conditions
                  </span>
              ...
              <div className="space-y-6">
                <label className="block">
                  ...
                  <textarea
                    className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg p-4 font-body-md placeholder:text-outline focus:border-primary transition-all"
                    placeholder="e.g. Appendectomy (2015), ACL Repair (2018)..."
                    rows={6}
                  ></textarea>
                </label>
                <div className="p-4 bg-secondary-container/30 rounded-lg border border-secondary-container flex gap-4 items-start">
                  ...
                  <p className="font-label-md text-on-secondary-container text-xs">
                    Your data is encrypted and only accessible by your verified
          ...
          <section
            className="hide-step step-transition space-y-8"
            id="wizard-step-2"
          >
            <div className="border-b border-outline-variant pb-6">
              <h1 className="font-headline-lg text-headline-lg text-primary mb-2">
              ...
              <p className="font-body-md text-on-surface-variant">
                List all currently active medications, including dosages, and
              ...
              <div className="pt-6 border-t border-outline-variant">
                <label className="block">
                  ...
                  <div className="relative">
                    <span
                      className="absolute left-4 top-3.5 material-symbols-outlined text-outline"
                      data-icon="warning"
                    >
                      warning
                    </span>
                    <input
                      className="w-full pl-12 bg-surface-container-lowest border border-outline-variant rounded-lg p-3 font-body-md"
          ...
          >
            <div className="border-b border-outline-variant pb-6">
              ...
              <p className="font-body-md text-on-surface-variant">
                Core physical measurements for baseline medical evaluation.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <label className="block">
                ...
                <input
                  className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg p-4 font-body-md focus:border-primary"
                  placeholder="175"
                  type="number"
                />
              </label>
            ...
            <div className="flex items-start gap-3 p-4 bg-primary-fixed/30 rounded-lg">
              ...
              <p className="font-body-md text-on-primary-fixed-variant">
                This information is strictly confidential and protected under
          ...
          <div className="mt-auto pt-10 flex justify-between items-center border-t border-outline-variant">
            <button
              className="invisible flex items-center gap-2 px-6 py-3 font-label-lg text-on-surface-variant hover:bg-surface-container transition-all rounded-lg"
              id="prev-btn"
            >
              <span
                className="material-symbols-outlined"
            ...
            <div className="flex gap-4">
              ...
              <button
                className="flex items-center gap-2 px-8 py-3 bg-primary text-on-primary font-label-lg rounded-lg shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all"
                id="next-btn"
              >
                Save &amp; Continue{" "}
                <span
